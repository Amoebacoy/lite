...
curl https://raw.githubusercontent.com/Amoebacoy/cv/main/ssh-vpn/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/Amoebacoy/cv/main/ins-xray/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/Amoebacoy/cv/main/ins-xray/index.html"
