...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
if [ "$cekup" = "day" ]; then
echo -e "${BICyan} ⇲  ${BICyan}System Uptime   ${NC}:  ${BIYellow}$uphours $upminutes $uptimecek${NC}"
else
echo -e "${BICyan} ⇲  ${BICyan}System Uptime   ${NC}:  ${BIYellow}$uphours $upminutes${NC}"
fi
echo -e "${BICyan} ⇲  ${BICyan}Current Domain  ${NC}:  ${BIYellow}$(cat /etc/xray/domain)${NC}"
echo -e "${BICyan} ⇲  ${BICyan}IP-VPS          ${NC}:  ${BIYellow}$IPVPS${NC}"
echo -e "${BICyan} ⇲  ${BICyan}ISP-VPS         ${NC}:  ${BIYellow}$ISPVPS${NC}"
echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗\033[0m${NC}"
echo -e "\E[39;1;92m                        ⇱ XRAY Lite ⇲                    \E[0m"
echo -e "${CYAN}╚══════════════════════════════════════════════════════════╝\033[0m${NC}"
echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗\033[0m${NC}"
echo -e "     ${LIGHT} NGINX ${NC}: ${GREEN}$resngx           ${LIGHT} Today  ${NC}: ${BIYellow}$ttoday${NC}"
echo -e "     ${LIGHT} XRAY  ${NC}: ${GREEN}$resv2r           ${LIGHT} Monthly${NC}: ${BIYellow}$tmon${NC}" 
echo -e "${CYAN}╚══════════════════════════════════════════════════════════╝\033[0m${NC}"
echo -e "${CYAN}╔══════════════════════════════════════════════════════════╗\033[0m${NC}"
